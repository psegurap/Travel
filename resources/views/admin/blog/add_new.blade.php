...
@section('title') {{__('New Post')}}@endsection
@section('styles')
   <style>
              ...
              <div class="col-lg-4">
                 <div class="blog_right_sidebar">
                    ...
                    <aside class="single_sidebar_widget search_widget pt-0">
                     <button @click="validate(saveTrip)" class="button rounded-0 primary-bg text-white w-100 btn_1 boxed-btn">{{__('Save Post')}}</button>
                    </aside>
